    ...
    <ScrollView
      ...
      {!token ? (
        ...
        <>
          ...
          {sourceRoute && (
            <View style={[NeoOutdoorStyles.editorialCard, styles.sourceRoutePanel]}>
              ...
              {sourceRouteCover && (
                <View style={styles.sourceRouteImageFrame}>
                  ...
                  return (
                    <View key={stop.id} style={styles.planStopItem}>
                      ...
                      <View style={styles.planStopCopy}>
                        ...
                        {stopPhoto && (
                          <View style={styles.stopThumbFrame}>
...
const styles = StyleSheet.create({
  ...
  rideSummaryPanel: {
    ...NeoOutdoorStyles.editorialCard,
    borderWidth: 1,
    padding: 16,
    marginBottom: 14,
  },
  ...
  rideSummaryMetric: {
    ...
    backgroundColor: NeoOutdoors.color.cyanWash,
    borderWidth: 1,
    borderColor: 'rgba(34,243,255,0.32)',
    paddingHorizontal: 12,
    paddingVertical: 10,
  },
  rideSummaryLabel: {
